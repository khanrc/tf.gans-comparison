...
def train():
    model = DCGAN(training=True, batch_size=batch_size, num_threads=num_threads, num_epochs=num_epochs)
    ...
    with tf.Session() as sess:
        ...
        summary_writer = tf.summary.FileWriter('./summary/train', flush_secs=20)
            ...
            while not coord.should_stop():
                ...
                if global_step % 10 == 0:
                    ...
                    if global_step % 1000 == 0:
                        saver.save(sess, './checkpoints/dcgan', global_step=global_step)
